...
for (i in 2:length(context_folder_vector)) {
  ...
  dev.new()
  plot_full
  ggsave(filename = file.path(gsub("data", "figures", context_folder_vector[i]),  "cmp_context_R_full.jpg"),
  ...
  ggsave(filename = file.path(gsub("data", "figures", context_folder_vector[i]),  "cmp_context_R_V1.jpg"),
  ...
  ggsave(filename = file.path(gsub("data", "figures", context_folder_vector[i]),  "cmp_context_R_V2.jpg"),
